...
if len(sys.argv) < 4:
	print 'usage is test_nih_pirc_siamese.py model weights.caffemodel output.csv path_to_file_with_input_image_paths [path_to_file_with_reference_images_paths..]'
