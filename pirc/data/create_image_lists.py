...
ABSOLUTE_PATH = '/home/robot/caffe/pirc/data/'
# '/work/04002/aa67857/caffe/pirc/data/'

# these folders are in ABSOLUTE_PATH. The ground truth table lists ref
# images first, then consumer images
REF_PATH = 'dr/'
CONSUMER_PATH = 'dc/'
REF_PATH_SS = 'dr_ss/'
CONSUMER_PATH_SS = 'dc_ss/'

TRAIN_1_PATH = 'train1_combined.txt'
TRAIN_2_PATH = 'train2_combined.txt'
TEST_1_PATH =  'test1_combined.txt'
TEST_2_PATH =  'test2_combined.txt'
...
def main():
    ...
    print "{} positive pairs from the ground truth table. " \
          "{} will be used for training.".format(pos_pairs, target_train_pairs)
